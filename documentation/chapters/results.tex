...
Finally we fixed several issues in the CGA application to allow the operation on Windows and Unix platforms. Most of the fixes handle cross compiler compatibility. Several fixes were made to handle eg. unix paths and other differences that appear on UNIX platforms.  See section 7 on guidelines how to prevent further incompatibilities.
