...
Finally we fixed several issues in CGA to allow the operation on Windows and Unix platforms at the same time. Most of the fixes handle cross compiler compatibility. Several minor fixes were made to handle eg. unix paths and other small differences that appear on unix platforms.
