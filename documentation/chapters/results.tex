...
Finally we fixed several issues in the CGA application to allow the operation on Windows and Unix platforms. Most of the fixes handle cross compiler compatibility. Several minor fixes were made to handle eg. unix paths and other small differences that appear on unix platforms.
