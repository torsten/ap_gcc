...
To build a project using CMake, \pathname{CMakeLists.txt} files need to created. Those files contain information on files to build, paths to include, libraries and executables to create, pre and post build activities and much more.
